  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="form-group focused">
        ...
        <input type="text"  class="form-control form-control-alternative" name="stu_name" value= "{{((old('stu_name')== null)? $student->student_name : old('stu_name')) }}" required placeholder="Name" >
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-lg-4">
      <div class="form-group">
        ...
        <input type="date"  class="form-control form-control-alternative datepicker" name="date_of_birth" value= "{{((old('date_of_birth')== null)? $student->date_of_birth : old('date_of_birth')) }}" placeholder="">
      </div>
    </div>
    <div class="col-lg-4">
      <div class="form-group focused">
        <label class="form-control-label" for="input-username">Nationality</label>
        <input type="text"  class="form-control form-control-alternative" name="nationality" value="{{((old('nationality')== null)? $student->nationality : old('nationality')) }}" placeholder="">
      </div>
    </div>
    <div class="col-lg-4">
      <div class="form-group">
        <label class="form-control-label" for="input-email">Religion</label>
        <input type="text"  class="form-control form-control-alternative" name="religion" value="{{((old('religion')== null)? $student->religion : old('religion')) }}" placeholder="">
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-12">
      <div class="form-group focused">
        <label class="form-control-label" for="input-username">Student Image</label>
          ...
          <img id="stu_image" width="200px" src="{{ asset('/storage/students/student/'.$student->image) }}" />
      </div>
    </div>
  </div>
