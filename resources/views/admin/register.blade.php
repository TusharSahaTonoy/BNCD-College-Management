            ...
            <form role="form" action="{{ route('user.register') }}" method="POST">
              ...
              <div class="form-group">
                <div class="input-group input-group-alternative mb-3">
                  ...
                  <input type="text" class="form-control" name="user_id" value="{{ old('user_id') }}" placeholder="Admin ID" >
                </div>
              </div>
              <div class="form-group">
                  <div class="input-group input-group-alternative mb-3">
                    ...
                    <input type="text" class="form-control" name="user_name" value="{{ old('user_name') }}" placeholder="Full Name" >
                  </div>
                </div>
