...
class SubjectMarks extends Model
{
    ...
    protected $fillable = [
        'class','group', 'subject', 'quiz1_cq', 'quiz1_mcq', 'quiz2_cq', 'quiz2_mcq', 'mid_cq', 'mid_mcq', 'quiz3_cq', 'quiz3_mcq', 'quiz4_cq', 'quiz4_mcq', 'final_cq', 'final_mcq', 'att_mark', 'student_id', 'teacher_id'
    ];
